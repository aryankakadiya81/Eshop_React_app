...
const Section_1p5 = () => {
    return (
        <>
            <Swiper className="mySwiper my-10 mx-5 border-b-2 pb-14">
...
export default Section_1p5
    ...
    //                 <div className=' border-0 border-custom-pink'>
    //                     <img src={asset8} className='w-[300px] h-56' />
    //                     <p className='text-center mt-5  font-bold'>Exercise Bike & Shaver Clean</p>
    //                 </div>
    //                 <div className='  border-0 '>
    //                     <img src={asset5} className='w-[300px] h-56' />
    //                     <p className='text-center mt-5  font-bold'>Wireless & Watches</p>
    ...
    //                 <div className='  border-0'>
    //                     <img src={asset7} className='w-[300px] h-56' />
    //                     <p className='text-center mt-5  font-bold'>Ipad Phone & Tablets</p>
    //                 </div>
    //             </div>
    //         </div>
    //     </div>
