...
import aset_11 from "../../../assets/asset 11.jpeg"
            ...
            <div className="containerrr">
                <div className="flex relative items-center mt-10">
                    ...
                    <div className='flex items-center justify-between w-[1120px]'>
                        ...
                        <div className="">
                            <button className='me-6 font-sans text-[14px] leading-[26px] text-center text-[#f50963] font-medium'>Top Rated</button>
                            <button className='me-6 font-sans text-[14px] leading-[26px] text-center font-medium'>Best Selling</button>
                            <button className='font-sans text-[14px] leading-[26px] text-center font-medium'>Latest Product</button>
                        </div>
                    </div>
                </div>
