...
import Section from "./Latest_Product.json";
import { Item } from '../../../../../App';

// import Ast1 from '../../../../../assets/asset11.jpeg';
                  ...
                  return (
                    <div className='main-product-card h-[400px] w-[300px] mt-5' key={ele.Name}>
                      <div className='bg-[#F6F8FA] h-[350px] w-[320px] relative'>
                        ...
                        <button onClick={Wish} className='h-10 heart w-10 mx-auto bg-white mt-2 shadow-md border duration-500 hover:bg-custom-pink rounded-sm ms-1'><i className="flex justify-center fa-regular fa-heart text-xl text-gray-700 hover:text-white duration-500"></i></button>
                        ...
                        <button onClick={Cart}> <div className='addtocart h-12 w-full pt-2 bg-black text-white text-center font-semibold items-center justify-center absolute bottom-0 hover:bg-custom-pink duration-500 '><i className=" me-2 fa-solid fa-cart-plus duration-500"></i>Add To Cart</div></button>
                      </div>
